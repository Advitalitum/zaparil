const domainsList = [
  'youtube.com','googleusercontent.com', 'googleapis.com','googlevideo.com', 'ytimg.com', 'youtu.be', 'ggpht.com', 'youtubei.googleapis.com', 'sponsor.ajay.app'
];
...
function FindProxyForURL(_, host) {
  ...
  if (useProxy) {
    ...
    return 'SOCKS 127.0.0.1:8055;DIRECT';
  }
